...
- **Works with llama-index tools and OpenAI tool schemas** You can easily convert llama-index tools or an OpenAI tool schemas together with a callable function, to a llama-cpp-aget tool and use things, like query engines etc. See in the examples below.
