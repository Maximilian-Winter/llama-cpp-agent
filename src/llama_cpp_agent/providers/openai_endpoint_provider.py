...
class CompletionRequestSettings:
    ...
    @staticmethod
    def load_from_file(file_path: str) -> "CompletionRequestSettings":
        """
        ...
        with open(file_path, 'r', encoding="utf-8") as file:
            ...
            return CompletionRequestSettings(**loaded_settings)

    @staticmethod
    def load_from_dict(settings: dict) -> "CompletionRequestSettings":
        """
        ...
        Returns:
            CreateCompletionRequest: The loaded settings.
        """
        return CompletionRequestSettings(**settings)
...
class OpenAIEndpointSettings:
    ...
    def create_completion(self, prompt, grammar, generation_settings: CompletionRequestSettings):
        """
        ...
        Args:
            ...
            generation_settings (CompletionRequestSettings): The generation settings.
